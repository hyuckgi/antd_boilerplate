    ...
    tabs : [
        {
            ...
            title : '도로명 주소',
            placeholder : '이하 상세주소 입력 (도로명, 건물번호)',
            notification : '찾으실 도로명 주소를 상세하게 입력해주세요.',
            subText : ['예) 강남구 역삼로 1, 수지구 죽전로 2'],
        },
        {
            
            title : '지번 주소',
            placeholder : '동/읍/면 입력',
            notification : '찾으실 동/읍/면을 입력해 주세요.',
            subText : ['예) 대치동, 청담동', '결과가 많을 경우, 검색어를 상세하게 입력해주세요.'],
        },
    ],
